...
<p>Navigando questo sito si acconsente all’utilizzo di cookie in conformità a quanto stabilito dal Garante per la protezione dei dati personali nel <a href="https://www.garanteprivacy.it/web/guest/home/docweb/-/docweb-display/docweb/9677876" target="_blank" rel="nofollow">provvedimento 231 dell’10 giugno 2021</a>. Se non si acconsente all’utilizzo di cookie occorre impostare il proprio browser in modo appropriato oppure non accedere ad alcuna pagina di questo sito. Se si decide di disabilitare i cookie ciò potrebbe influenzare negativamente l’esperienza di navigazione all’interno del sito.</p>
...
<p><strong>Che tipi di cookie usiamo?</strong></p>
...
<ul>
<li><strong>Cookie tecnici</strong>: permettono di migliorare la navigabilità del sito e l’esperienza dell’utente. Possono essere suddivisi in <i>cookie di navigazione o di sessione</i>, permettendo, ad esempio, di effettuare un acquisto o di autenticarsi per accedere ad aree riservate, e in <i>cookie di funzionalità</i>, che permettono all’utente di navigare il sito in base ai criteri scelti, come ad esempio la lingua. Per l’installazione di tali cookie non è richiesto il consenso preventivo degli utenti.</li>
<li><strong>Cookie di profilazione</strong>: permettono di tracciare l’utente e di ricavarne informazioni utili a scopi successivi. I cookie di profilazione spesso vengono utilizzati per il remarketing della pubblicità, per ottenere informazioni riguardo le abitudini o gli interessi dell’utente, oppure per tracciare specifici comportamenti. Tramite questi cookie, poi, i siti sono in grado di migliorare servizi come la pubblicità, messaggi personalizzati, ecc</li>
</ul>
<p>Queste due tipologie di cookie possono a loro volta essere:</p>
<ul>
<li><strong>Cookie di prima parte</strong>: sono tutti i cookie di nostra proprietà che il sito installa direttamente nel dispositivo dell’utente. I cookie di prima parte presenti in questo sito sono solamente tecnici.</li>
</ul>
<p><strong>Cookie di terze parti</strong>: sono i cookie predisposti e gestiti da responsabili estranei (c.d. terze parti) al nostro sito web. Non avendo accesso alle impostazioni di detti cookie, l’utente può esercitare i propri diritti solo e unicamente tramite le modalità previste dalla terza parte che conserva le informazioni (nella tabella in fondo alla presente informativa c’è uno schema riassuntivo con tutti i riferimenti in merito)</p>
...
<p><a href="//windows.microsoft.com/en-us/windows-vista/block-or-allow-cookies" target="_blank" rel="nofollow">Microsoft Windows Explorer</a></p>
<p><a href="https://support.google.com/chrome/answer/95647?hl=en&amp;p=cpn_cookies" target="_blank" rel="nofollow">Google Chrome </a></p>
<p><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences?redirectlocale=en-US&amp;redirectslug=Enabling+and+disabling+cookies" target="_blank" rel="nofollow">Mozilla Firefox </a></p>
<p><a href="https://support.apple.com/kb/PH17191?locale=it_IT" target="_blank" rel="nofollow">Apple Safari </a></p>
...
<p>È possibile opporsi alla registrazione dei cookies anche utilizzando la piattaforma di disiscrizione dell’IAB (Interactive Advertising Bureau) Europe collegandosi alla seguente piattaforma: <a href="//www.youronlinechoices.com/it/" target="_blank" rel="nofollow">//www.youronlinechoices.com/it/</a>.</p>
...
<p><a href="//www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager02.html#118539" target="_blank" rel="nofollow">Disabilitazione dei cookie Flash</a></p>
<p><strong>Cookie utilizzati in questo sito</strong></p>
...
<td class="LinkCookie"><a href="https://policies.google.com/technologies/cookies?hl=en" target="_blank" rel="nofollow">Link</a></td>
</tr>
<tr>
<td class="NomeCookie">DoubleClick</td>
<td class="DescCookie">Cookie di terze parti che invia pubblicità in linea con le tue preferenze</td>
<td class="LinkCookie"><a href="//www.google.com/intl/en/policies/privacy/" target="_blank" rel="nofollow">Link</a></td>
</tr>
